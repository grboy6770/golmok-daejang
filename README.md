...
가을마다 길에서 그 냄새가 나는 이유: 서울 가로수 283,330그루 중 **99,394그루가 은행나무**이고,
열매(와 냄새)는 그중 암나무에서만 나옵니다. 서울시 데이터에 암나무로 기록된 16,634그루 주변을
**냄새 구간**으로 칠했습니다.
...
길에서 쓰레기통 찾아 헤맨 적 있다면. **가로쓰레기통 6,234개**와 **의류수거함 8,822개**의
...
| 데이터 | 출처 | 규모 | 갱신 |
|--------|------|------|------|
| 가로수 위치 | [서울 열린데이터광장 OA-22904](https://data.seoul.go.kr/dataList/OA-22904/S/1/datasetView.do) | 283,330그루 | 연 1회 |
...
OpenStreetMap Nominatim으로 채웠습니다. 결과: 쓰레기통 91%, 의류수거함 94% 매칭.
